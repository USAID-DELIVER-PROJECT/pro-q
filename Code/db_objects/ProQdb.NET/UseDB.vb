Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("UseDB_NET.UseDB")> Public Class UseDB
	' TODO: Declare local ADO Recordset object. For example:
	'the name of the table or view used by this class
    Private Const m_strTable As String = DB_TABLE_USE
    Private Const m_strSQL As String = "Select * From " & DB_TABLE_USE
