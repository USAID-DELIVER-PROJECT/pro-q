Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("ProtocolBrandCollectionDB_NET.ProtocolBrandCollectionDB")> Public Class ProtocolBrandCollectionDB
	'ProtocolBrandCollectionDB.cls
	'
    ...
    Public Function GetCollection(ByRef strStoredProc As String, ByRef aParams(,) As Object) As Collection
        ...
        With m_objRS
            For i = 0 To .Tables(strStoredProc).Rows.Count - 1 'Do Until .EOF
                Dim objDB As New ProtocolBrandDB
        ...
        'UPGRADE_NOTE: Object m_objRS may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        'm_objRS = Nothing
