Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("ProtocolTestDB_NET.ProtocolTestDB")> Public Class ProtocolTestDB
	'ProtocolTestDB.cls
	'
	'this class manages the persistent data for the protocols test. a
	'protocol test is one of the elements of a level.
	'
	'lbailey
	'2 june 2002
	...
	Private Const m_strTable As String = DB_TABLE_PROTOCOL_TEST
    Private Const m_strSQL As String = "Select * FROM " & DB_TABLE_PROTOCOL_TEST
	...
	'the name of this level ("A", "B", etc.)
        ...
        For i = 0 To m_objRS.Tables(m_strTable).Rows.Count - 1
            ...
            If strGuid = strID Then
                With m_objRS.Tables(m_strTable).Rows(i)
                    ...
                    m_strLevelID = CType((.Item("guidID_ProtocolLevel")), Guid).ToString()
    ...
    Public Sub Update()
        ...
        If m_fIsNew Then
            ...
            dsNewRow.Item("guidID_ProtocolLevel") = New Guid(m_strLevelID)
            ...
            With m_objRS
                For i = 0 To .Tables(m_strTable).Rows.Count - 1
                    ...
                    If strGuid = m_strID Then
                        ...
                        .Tables(m_strTable).Rows(i).Item("guidID_ProtocolLevel") = New Guid(m_strLevelID)
