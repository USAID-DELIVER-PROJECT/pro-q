Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("NeedDB_NET.NeedDB")> Public Class NeedDB
	'NeedDB.cls
	'Creates Sets the Need Object
	'18-June-2002 jleiner
	...
	'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	Private Const DB_TABLE_NEED As String = "tlkNeed"
    ...
    Private Const m_strTable As String = DB_TABLE_NEED
    Private Const m_strSQL As String = "Select * From " & DB_TABLE_NEED
    ...
    Private m_strMethodologyID As String 'The MethodologyID
        ...
        For i = 0 To rst.Tables(m_strTable).Rows.Count - 1
            ...
            If strGuid = strID Then
                With rst.Tables(m_strTable).Rows(i)
                    ...
                    m_strFormula = IIf(IsDBNull(.Item("strFormula")), "", .Item("strFormula"))
                End With
    ...
    Public Function Create() As String
        ...
        dsNewRow.Item("guidID_Methodology") = New Guid(m_strMethodologyID)
        dsNewRow.Item("strFormula") = m_strFormula
        ...
        With rst
            For i = 0 To .Tables(m_strTable).Rows.Count - 1
                ...
                If strGuid = m_strID Then
                    ...
                    .Tables(m_strTable).Rows(i).Item("strFormula") = m_strFormula
                    'write the record
	...
	Public Sub setMethodologyID(ByRef strMethodologyID As String)
