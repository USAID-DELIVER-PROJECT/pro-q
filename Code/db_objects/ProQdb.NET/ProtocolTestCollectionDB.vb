Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("ProtocolTestDBCollection_NET.ProtocolTestDBCollection")> Public Class ProtocolTestDBCollection
    ...
    Public Function GetCollection(ByRef strStoredProc As String, ByRef aParams(,) As Object) As Collection
        ...
        With objRS
            For i = 0 To .Tables(strStoredProc).Rows.Count - 1 'Do Until .EOF
                ...
                Dim objDB As New ProtocolTestDB
