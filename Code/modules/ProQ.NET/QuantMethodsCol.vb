Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("QuantMethods_NET.QuantMethods")> Public Class QuantMethods
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As QuantMethod
		'create a new object
		Dim objNewMember As QuantMethod
		objNewMember = New QuantMethod
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As QuantMethod
		Get
