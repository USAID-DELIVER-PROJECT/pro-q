Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("FundingSources_NET.FundingSources")> Public Class FundingSources
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As FundingSource
		'create a new object
		Dim objNewMember As FundingSource
		objNewMember = New FundingSource
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As FundingSource
		Get
