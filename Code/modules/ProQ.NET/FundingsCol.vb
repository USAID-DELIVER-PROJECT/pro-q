Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("Fundings_NET.Fundings")> Public Class Fundings
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As Funding
		'create a new object
		Dim objNewMember As Funding
		objNewMember = New Funding
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Funding
		Get
