Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("Sections_NET.Sections")> Public Class Sections
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As Section
		'create a new object
		Dim objNewMember As Section
		objNewMember = New Section
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Section
		Get
