Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("UseFundings_NET.UseFundings")> Public Class UseFundings
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As UseFunding
		'create a new object
		Dim objNewMember As UseFunding
		objNewMember = New UseFunding
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As UseFunding
		Get
