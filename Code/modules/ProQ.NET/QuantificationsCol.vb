Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("Quantifications_NET.Quantifications")> Public Class Quantifications
	Implements System.Collections.IEnumerable
	'local variable to hold collection
	Private mCol As Collection
	
	Public Function Add(Optional ByRef sKey As String = "") As Quantification
		'create a new object
		Dim objNewMember As Quantification
		objNewMember = New Quantification
    ...
    Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Quantification
        Get
